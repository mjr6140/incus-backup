...
- Prune retention for restic targets using `restic forget --prune`, including preview/confirmation flows and automated coverage.

In Progress / Upcoming
1) Concurrency, locking, and observability
